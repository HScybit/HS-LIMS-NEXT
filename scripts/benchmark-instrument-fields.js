...
const fixtures = [
  ...
  { name: 'large', fieldCount: 100, instrumentCount: 10, serviceCount: 10, readP95Ms: 400, listP95Ms: 600, saveP95Ms: 1500, generationP95Ms: 700, payloadBytes: 1572864 },
  { name: 'complex', fieldCount: 500, instrumentCount: 100, serviceCount: 100, readP95Ms: 1500, listP95Ms: 3500, saveP95Ms: 6000, generationP95Ms: 1500, payloadBytes: 16777216 },
];
...
try {
  ...
  for (const fixture of fixtures) {
    ...
    const serviceTypes = Array.from({ length: fixture.serviceCount }, (_, index) => ({ id: randomUUID(), serviceCode: index === 0 ? 'calibration' : 'service_' + index, displayLabel: 'Service ' + index, isActive: true }));
    await saveModuleAccessSettings({ ...account, ...session }, modules, { instrumentServiceTypes: serviceTypes });
