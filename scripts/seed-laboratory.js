...
try {
  ...
  if (account.roleRevision === 0) for (const permission of ['templates.read', 'templates.manage', 'samples.read', 'samples.create', 'samples.manage', 'test_requests.allocate', 'datasheets.execute', 'report_settings.read', 'report_settings.manage', 'masters.read', 'masters.manage', 'roles.read', 'roles.manage', 'users.read', 'users.manage', 'checklists.read', 'checklists.manage', 'settings.read', 'settings.manage']) {
