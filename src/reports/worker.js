...
export function reportPdfFailure(error) {
  ...
  if (['incomplete_sample_product_history', 'sample_product_context_limit', 'template_image_history_unavailable', 'report_not_found', 'report_history_unavailable', 'report_asset_history_unavailable', 'report_image_unavailable', 'invalid_report_image', 'empty_report_image', 'report_image_size_limit', 'report_image_type', 'report_image_dimensions', 'animated_report_image', 'unsafe_report_html', 'unsafe_report_svg', 'report_svg_limit', 'template_not_found', 'capture_not_found', 'template_batch_limit', 'capture_batch_limit', 'report_size_limit'].includes(error.code)) {
