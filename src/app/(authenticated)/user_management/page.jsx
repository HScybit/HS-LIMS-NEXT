...
export default async function Page() {
  ...
  return <Suspense fallback={<AppLoader />}><UserList key={`${identity.organizationId}:${identity.userId}`} currentUserId={identity.userId} canManage={identity.permissions.includes('users.manage')} bulkResources={allowedMasterBulkResources(identity.permissions)} /></Suspense>;
}
