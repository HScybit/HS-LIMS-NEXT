...
import { loadUserStatusHistory } from '@/users/status.js';
...
export const GET = endpoint(async (request, context) => {
  ...
  return json(await authenticated(request, (client, identity) => loadUserStatusHistory(client, identity, userId, input), { readOnly: true }));
});
