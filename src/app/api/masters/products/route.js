...
import { listProducts, saveProduct } from '@/masters/products.js';
...
export const GET = endpoint(async (request) => {
  ...
  return json(await authenticated(request, (client, identity) => listProducts(client, identity, input), { readOnly: true }));
});
