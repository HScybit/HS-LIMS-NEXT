...
const stores = Object.freeze({
  ...
  instrument: Object.freeze({ label: 'Instrument', alias: 'instrument', fieldTable: 'instrument_version_custom_fields', valueTable: 'instrument_version_custom_field_values', idColumn: 'instrument_id' }),
});
