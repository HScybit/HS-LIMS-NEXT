...
export const masterBulkBatches = pgTable('master_bulk_batches', {
  ...
  check('master_bulk_batch_fields', sql`resource IN ('products','test-parameters','methods','users','customers','vendors')
...
export const masterBulkAttempts = pgTable('master_bulk_attempts', {
  ...
  foreignKey({ name: 'master_bulk_attempt_vendor_fk', columns: [table.organizationId, table.vendorId, table.resultRevision], foreignColumns: [vendorVersions.organizationId, vendorVersions.vendorId, vendorVersions.revision] }),
