...
export async function createWorkflow(client, identity, input) {
  ...
  if (!['sample', 'test_request', 'instrument_service', 'document'].includes(input.appliesTo)) throw new HttpError(400, 'invalid_workflow_type', 'Select a supported workflow type.');
  return mutation(async () => {
