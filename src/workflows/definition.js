...
export async function loadWorkflowDefinition(client, identity, versionId) {
  ...
  if (!['workflows.read', 'workflows.manage', 'samples.read', 'samples.manage', 'test_requests.allocate', 'datasheets.execute', 'approvals.respond', 'documents.read', 'documents.manage']
