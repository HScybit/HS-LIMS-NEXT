...
export const moduleAccessDefinitions = Object.freeze([
  ...
  Object.freeze({ key: 'instrument', label: 'Instrument' }),
  Object.freeze({ key: 'service_agreements', label: 'Service Agreements' }),
  Object.freeze({ key: 'inventory', label: 'Inventory' }),
]);
...
export function moduleAccessSettingsInput(input) {
  ...
  if (!Array.isArray(input.moduleAccess) || ![2, 3, 4, 5].includes(input.moduleAccess.length)) {
