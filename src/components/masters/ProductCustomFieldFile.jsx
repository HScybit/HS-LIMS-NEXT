...
export default function ProductCustomFieldFile({ field, value, stored, disabled, error, onChange, onBusy }) {
  ...
  const id = `product-custom-field-${field.id}`; const fileId = String(value ?? '').trim();
