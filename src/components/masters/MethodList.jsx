...
export default function MethodList({ canManage, bulkResources }) {
  ...
  return <>
    <PageHeader><div className="page-header"><div className="container-fluid h-100"><div className="row h-100 align-items-center justify-content-between page-header__row">
      ...
      <div className="col-auto page-header__actions d-flex gap-2">{canManage ? <><MasterBulkButton resource="methods" resources={bulkResources} /><PrimaryButton leftIcon="plus" onClick={() => router.push(`/method_of_analysis/new?from=${encodeURIComponent(returnPath)}`)}>New Method of Analysis</PrimaryButton></> : null}</div>
