  ...
  function navigation(mobile = false) {
    return <aside className={`lims-sidebar d-flex flex-column ${!mobile && collapsed ? 'is-collapsed' : ''}`}>
      ...
      <div className="sidebar-nav flex-grow-1">
        {identity.masterModules?.instrument ? <section className="sidebar-section"><div className="sidebar-label"><span>Instruments</span></div><div className="d-grid gap-1"><Link href="/equipments" className={`sidebar-link btn text-start ${pathname.startsWith('/equipments') ? 'is-active' : ''}`} aria-label="Instruments" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="activity" size={20} /></span><span className="hide-menu">Instruments</span></Link></div></section> : null}
        {identity.permissions.some((permission) => ['masters.read', 'masters.manage'].includes(permission)) ? <section className="sidebar-section"><div className="sidebar-label"><span>Master Data</span></div><div className="d-grid gap-1"><Link href="/test_parameters" className={`sidebar-link btn text-start ${pathname.startsWith('/test_parameters') ? 'is-active' : ''}`} aria-label="Test Parameters" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="list" size={20} /></span><span className="hide-menu">Test Parameters</span></Link><Link href="/method_of_analysis" className={`sidebar-link btn text-start ${pathname.startsWith('/method_of_analysis') ? 'is-active' : ''}`} aria-label="Method of Analysis" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="list" size={20} /></span><span className="hide-menu">Method of Analysis</span></Link><Link href="/products" className={`sidebar-link btn text-start ${pathname.startsWith('/products') ? 'is-active' : ''}`} aria-label="Products" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="list" size={20} /></span><span className="hide-menu">Products</span></Link>{identity.masterModules?.customer ? <Link href="/customer_masters" className={`sidebar-link btn text-start ${pathname.startsWith('/customer_masters') ? 'is-active' : ''}`} aria-label="Customer Masters" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="list" size={20} /></span><span className="hide-menu">Customer Masters</span></Link> : null}{identity.masterModules?.vendor ? <Link href="/vendor_masters" className={`sidebar-link btn text-start ${pathname.startsWith('/vendor_masters') ? 'is-active' : ''}`} aria-label="Vendors" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="list" size={20} /></span><span className="hide-menu">Vendors</span></Link> : null}{identity.masterModules?.service_agreements ? <Link href="/service_agreements" className={`sidebar-link btn text-start ${pathname.startsWith('/service_agreements') ? 'is-active' : ''}`} aria-label="Service Agreements" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="list" size={20} /></span><span className="hide-menu">Service Agreements</span></Link> : null}<Link href="/project_fields" className={`sidebar-link btn text-start ${pathname.startsWith('/project_fields') ? 'is-active' : ''}`} aria-label="Custom Fields" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="list" size={20} /></span><span className="hide-menu">Custom Fields</span></Link></div></section> : null}
        {identity.permissions.some((permission) => ['masters.read', 'masters.manage'].includes(permission)) ? <section className="sidebar-section"><div className="sidebar-label"><span>Materials</span></div><div className="d-grid gap-1">
        ...
        {identity.permissions.some((permission) => ['settings.read', 'settings.manage', 'roles.read', 'roles.manage', 'users.read', 'users.manage', 'checklists.read', 'checklists.manage', 'workflows.read', 'workflows.manage', 'compliance.read', 'compliance.manage'].includes(permission)) ? <section className="sidebar-section"><div className="sidebar-label"><span>Administration</span></div><div className="d-grid gap-1">
          {identity.permissions.some((permission) => ['settings.read', 'settings.manage'].includes(permission)) ? <Link href="/organization_settings" className={`sidebar-link btn text-start ${pathname === '/organization_settings' || pathname.startsWith('/administration/') && !isRoleManagement ? 'is-active' : ''}`} aria-label="Organization Settings" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="settings" size={20} /></span><span className="hide-menu">Organization Settings</span></Link> : null}
          {identity.permissions.some((permission) => ['roles.read', 'roles.manage'].includes(permission)) ? <Link href="/role_management" className={`sidebar-link btn text-start ${isRoleManagement ? 'is-active' : ''}`} aria-label="Role Master" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="users" size={20} /></span><span className="hide-menu">Role Master</span></Link> : null}
          {identity.permissions.some((permission) => ['users.read', 'users.manage'].includes(permission)) ? <Link href="/user_management" className={`sidebar-link btn text-start ${pathname.startsWith('/user_management') ? 'is-active' : ''}`} aria-label="User Management" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="users" size={20} /></span><span className="hide-menu">User Management</span></Link> : null}
          {identity.permissions.some((permission) => ['users.read', 'users.manage'].includes(permission)) ? <Link href="/unit_management" className={`sidebar-link btn text-start ${pathname.startsWith('/unit_management') ? 'is-active' : ''}`} aria-label="Units" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="users" size={20} /></span><span className="hide-menu">Units</span></Link> : null}
          {identity.permissions.some((permission) => ['users.read', 'users.manage'].includes(permission)) ? <Link href="/lab_management" className={`sidebar-link btn text-start ${pathname.startsWith('/lab_management') ? 'is-active' : ''}`} aria-label="Labs" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="fa-flask" size={20} /></span><span className="hide-menu">Labs</span></Link> : null}
          {identity.permissions.some((permission) => ['compliance.read', 'compliance.manage'].includes(permission)) ? <Link href="/nabl_certificates" className={`sidebar-link btn text-start ${pathname.startsWith('/nabl_certificates') ? 'is-active' : ''}`} aria-label="NABL Certifications" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="file-description" size={20} /></span><span className="hide-menu">NABL Certifications</span></Link> : null}
          {identity.permissions.some((permission) => ['checklists.read', 'checklists.manage'].includes(permission)) ? <Link href="/checklists" className={`sidebar-link btn text-start ${pathname.startsWith('/checklists') ? 'is-active' : ''}`} aria-label="Checklists" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="list" size={20} /></span><span className="hide-menu">Checklists</span></Link> : null}
          {identity.permissions.some((permission) => ['workflows.read', 'workflows.manage'].includes(permission)) ? <Link href="/workflow_management" className={`sidebar-link btn text-start ${pathname.startsWith('/workflow_management') ? 'is-active' : ''}`} aria-label="Workflow Master" onClick={() => setMobileOpen(false)}><span className="smplfy-sidebar-link-icon" aria-hidden="true"><AppIcon name="activity" size={20} /></span><span className="hide-menu">Workflow Master</span></Link> : null}
        </div></section> : null}
