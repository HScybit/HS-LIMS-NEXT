...
const serviceColumns = `id,position,service_code AS "serviceCode",service_label AS "serviceLabel",
...
export function instrumentError(error) {
  ...
  const messages = {
    ...
    instrument_service_reference: [400, 'invalid_instrument_service_reference', 'Select a supported Instrument service type and its templates and workflows.'],
