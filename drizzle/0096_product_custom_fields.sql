CREATE TABLE "product_version_custom_field_values" (
	...
	"user_id" uuid,
	"attachment_id" uuid,
	CONSTRAINT "product_custom_value_pk" PRIMARY KEY("organization_id","product_id","revision","field_id","position"),
	CONSTRAINT "product_custom_value_raw" CHECK ("product_version_custom_field_values"."position" between 0 and 499 and num_nonnulls("product_version_custom_field_values"."raw_text","product_version_custom_field_values"."raw_number","product_version_custom_field_values"."raw_boolean")=1
    and (("product_version_custom_field_values"."raw_kind"='text' and "product_version_custom_field_values"."raw_text" is not null and length("product_version_custom_field_values"."raw_text")<=16000)
      or ("product_version_custom_field_values"."raw_kind"='number' and "product_version_custom_field_values"."raw_number" is not null and "product_version_custom_field_values"."raw_number" between '-1.7976931348623157e308'::double precision and '1.7976931348623157e308'::double precision)
      or ("product_version_custom_field_values"."raw_kind"='boolean' and "product_version_custom_field_values"."raw_boolean" is not null))),
	CONSTRAINT "product_custom_value_number_text" CHECK (case when "product_version_custom_field_values"."raw_kind"='number' then
    "product_version_custom_field_values"."raw_number_text" is not null and length("product_version_custom_field_values"."raw_number_text") between 1 and 32
    and case when "product_version_custom_field_values"."raw_number_text" ~ '^-?(0|[1-9][0-9]*)([.][0-9]+)?(e[+-]?[0-9]+)?$'
      then "product_version_custom_field_values"."raw_number_text"::double precision="product_version_custom_field_values"."raw_number" else false end
    else "product_version_custom_field_values"."raw_number_text" is null end),
	CONSTRAINT "product_custom_value_interpretation" CHECK ("product_version_custom_field_values"."interpretation_state" in ('empty','valid','invalid','out_of_range')
...
CREATE TABLE "product_version_custom_fields" (
	"organization_id" uuid NOT NULL,
	"product_id" uuid NOT NULL,
	"revision" integer NOT NULL,
	"field_id" uuid NOT NULL,
	...
	CONSTRAINT "product_custom_field_pk" PRIMARY KEY("organization_id","product_id","revision","field_id"),
	CONSTRAINT "product_custom_field_position" UNIQUE("organization_id","product_id","revision","position"),
	CONSTRAINT "product_custom_field_shape" CHECK ("product_version_custom_fields"."position" between 0 and 499 and "product_version_custom_fields"."value_count" between 0 and 500
    and ("product_version_custom_fields"."is_array" or "product_version_custom_fields"."value_count"=1)
    and "product_version_custom_fields"."field_type" in ('text','number','date','select','lookup','longtext','attachment','multi_user_select','date_time','checkbox','email')),
	CONSTRAINT "product_custom_field_display" CHECK (num_nonnulls("product_version_custom_fields"."display_text","product_version_custom_fields"."display_number","product_version_custom_fields"."display_boolean")=1
    and (("product_version_custom_fields"."display_kind"='text' and "product_version_custom_fields"."display_text" is not null and length("product_version_custom_fields"."display_text")<=8000998)
      or ("product_version_custom_fields"."display_kind"='number' and "product_version_custom_fields"."display_number" is not null and "product_version_custom_fields"."display_number" between '-1.7976931348623157e308'::double precision and '1.7976931348623157e308'::double precision)
      or ("product_version_custom_fields"."display_kind"='boolean' and "product_version_custom_fields"."display_boolean" is not null))
    and (not "product_version_custom_fields"."is_array" or "product_version_custom_fields"."display_kind"='text')),
	CONSTRAINT "product_custom_field_zone" CHECK (("product_version_custom_fields"."field_type" in ('date','date_time') and "product_version_custom_fields"."time_zone" is not null
      and length("product_version_custom_fields"."time_zone") between 1 and 100 and "product_version_custom_fields"."time_zone_data_version" is not null and length("product_version_custom_fields"."time_zone_data_version") between 1 and 40
      and "product_version_custom_fields"."date_parser_version" is not null and length("product_version_custom_fields"."date_parser_version") between 1 and 80)
    or ("product_version_custom_fields"."field_type" not in ('date','date_time') and num_nonnulls("product_version_custom_fields"."time_zone","product_version_custom_fields"."time_zone_data_version","product_version_custom_fields"."date_parser_version")=0))
);
--> statement-breakpoint
ALTER TABLE "products" ADD COLUMN "custom_field_count" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "products" ADD COLUMN "custom_fields_provided" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "product_versions" ADD COLUMN "custom_field_count" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "product_versions" ADD COLUMN "custom_fields_provided" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "organization_laboratory_settings" ADD COLUMN "scheme_current_year_digits" text;--> statement-breakpoint
ALTER TABLE "organization_laboratory_settings" ADD COLUMN "scheme_next_year_digits" text;--> statement-breakpoint
ALTER TABLE "organization_laboratory_settings" ADD COLUMN "scheme_separator" text;--> statement-breakpoint
ALTER TABLE "organization_laboratory_settings" ADD COLUMN "scheme_month_format" text;--> statement-breakpoint
ALTER TABLE "organization_laboratory_settings" ADD COLUMN "scheme_non_nabl_start_number" text;--> statement-breakpoint
ALTER TABLE "product_version_custom_field_values" ADD CONSTRAINT "product_version_custom_field_values_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_version_custom_field_values" ADD CONSTRAINT "product_custom_value_field_fk" FOREIGN KEY ("organization_id","product_id","revision","field_id") REFERENCES "public"."product_version_custom_fields"("organization_id","product_id","revision","field_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_version_custom_field_values" ADD CONSTRAINT "product_custom_value_option_fk" FOREIGN KEY ("organization_id","field_id","option_revision","option_id") REFERENCES "public"."custom_field_version_options"("organization_id","field_id","revision","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_version_custom_field_values" ADD CONSTRAINT "product_custom_value_user_fk" FOREIGN KEY ("organization_id","user_id") REFERENCES "public"."memberships"("organization_id","user_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_version_custom_field_values" ADD CONSTRAINT "product_custom_value_attachment_fk" FOREIGN KEY ("organization_id","attachment_id") REFERENCES "public"."custom_field_attachments"("organization_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_version_custom_fields" ADD CONSTRAINT "product_version_custom_fields_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_version_custom_fields" ADD CONSTRAINT "product_custom_field_product_fk" FOREIGN KEY ("organization_id","product_id","revision") REFERENCES "public"."product_versions"("organization_id","product_id","revision") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "product_version_custom_fields" ADD CONSTRAINT "product_custom_field_definition_fk" FOREIGN KEY ("organization_id","field_id","field_revision") REFERENCES "public"."custom_field_versions"("organization_id","field_id","revision") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "product_custom_value_raw_search" ON "product_version_custom_field_values" USING btree ("organization_id","field_id",md5("raw_text"),"product_id","revision") WHERE "product_version_custom_field_values"."raw_text" is not null;--> statement-breakpoint
CREATE INDEX "product_custom_field_definition" ON "product_version_custom_fields" USING btree ("organization_id","field_id","product_id","revision");--> statement-breakpoint
CREATE INDEX "products_scheme_order" ON "products" USING btree ("organization_id","created_at","updated_at","id") WHERE "products"."active";--> statement-breakpoint
ALTER TABLE "products" ADD CONSTRAINT "product_custom_field_count" CHECK ("products"."custom_field_count" between 0 and 500);--> statement-breakpoint
ALTER TABLE "product_versions" ADD CONSTRAINT "product_version_custom_fields" CHECK ("product_versions"."custom_field_count" between 0 and 500 and ("product_versions"."operation"<>'retire' or not "product_versions"."custom_fields_provided"));--> statement-breakpoint
ALTER TABLE "organization_laboratory_settings" ADD CONSTRAINT "lab_settings_scheme_values" CHECK (length("organization_laboratory_settings"."scheme_current_year_digits")<=128 and length("organization_laboratory_settings"."scheme_next_year_digits")<=128
    and length("organization_laboratory_settings"."scheme_separator")<=250 and length("organization_laboratory_settings"."scheme_non_nabl_start_number")<=128
    and ("organization_laboratory_settings"."scheme_month_format" is null or "organization_laboratory_settings"."scheme_month_format" in ('','number','short','long')));
--> statement-breakpoint
CREATE FUNCTION masters_custom_field_trim(value text) RETURNS text
...
$$;
--> statement-breakpoint
CREATE FUNCTION masters_lock_custom_field_definition_set() RETURNS trigger
LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$
BEGIN
  PERFORM pg_advisory_xact_lock(hashtextextended('custom-field-definitions:'||NEW.organization_id::text,0));
  RETURN NEW;
END $$;
CREATE TRIGGER custom_field_definition_set_lock BEFORE INSERT OR UPDATE ON custom_field_definitions
  FOR EACH ROW EXECUTE FUNCTION masters_lock_custom_field_definition_set();
--> statement-breakpoint
CREATE FUNCTION masters_assert_product_custom_fields(target_organization uuid,target_product uuid,target_revision integer,check_definition_set boolean DEFAULT false) RETURNS void
LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$
DECLARE version public.product_versions; field_count integer; minimum_position integer; maximum_position integer; item_count integer;
BEGIN
  ...
  IF NOT FOUND THEN RAISE EXCEPTION 'Product Custom Field history is missing' USING ERRCODE='23514',CONSTRAINT='product_custom_field_complete'; END IF;
  SELECT count(*),min(position),max(position),coalesce(sum(value_count),0) INTO field_count,minimum_position,maximum_position,item_count
    FROM public.product_version_custom_fields
    WHERE organization_id=target_organization AND product_id=target_product AND revision=target_revision;
  IF field_count<>version.custom_field_count OR item_count>5000
    ...
    RAISE EXCEPTION 'Product Custom Fields require a complete ordered version' USING ERRCODE='23514',CONSTRAINT='product_custom_field_complete';
  END IF;
  IF EXISTS (
    SELECT 1 FROM public.product_version_custom_fields field LEFT JOIN LATERAL (
      SELECT count(*) AS count,min(position) AS minimum,max(position) AS maximum
      FROM public.product_version_custom_field_values value
      WHERE value.organization_id=field.organization_id AND value.product_id=field.product_id
  ...
  ) THEN RAISE EXCEPTION 'Product Custom Field items require a complete ordered version' USING ERRCODE='23514',CONSTRAINT='product_custom_value_complete'; END IF;
  IF version.custom_fields_provided THEN
    IF check_definition_set AND (EXISTS (
      SELECT id,revision FROM public.custom_field_definitions WHERE organization_id=target_organization AND active AND associated_with='product'
      EXCEPT SELECT field_id,field_revision FROM public.product_version_custom_fields
        WHERE organization_id=target_organization AND product_id=target_product AND revision=target_revision
    ) OR EXISTS (
      SELECT field_id,field_revision FROM public.product_version_custom_fields
        WHERE organization_id=target_organization AND product_id=target_product AND revision=target_revision
      EXCEPT SELECT id,revision FROM public.custom_field_definitions WHERE organization_id=target_organization AND active AND associated_with='product'
    )) THEN RAISE EXCEPTION 'Product Custom Field definitions changed' USING ERRCODE='23514',CONSTRAINT='product_custom_field_definition_set'; END IF;
    IF EXISTS (
      ...
      WHERE field.organization_id=target_organization AND field.product_id=target_product AND field.revision=target_revision AND definition.is_required
      AND NOT (
        ...
        OR EXISTS (
        SELECT 1 FROM public.product_version_custom_field_values value
        WHERE value.organization_id=field.organization_id AND value.product_id=field.product_id AND value.revision=field.revision AND value.field_id=field.field_id
          AND CASE
    ...
    ) THEN RAISE EXCEPTION 'A required Product Custom Field is empty' USING ERRCODE='23514',CONSTRAINT='product_custom_field_required'; END IF;
  END IF;
END $$;
--> statement-breakpoint
CREATE FUNCTION masters_product_custom_field_unique_text(is_array boolean,raw_kind text,raw_text text,raw_number double precision,raw_boolean boolean,raw_number_text text) RETURNS text
LANGUAGE plpgsql IMMUTABLE SET search_path=pg_catalog,public SET extra_float_digits=3 AS $$
DECLARE normalized text;
BEGIN
  IF NOT is_array AND ((raw_kind='boolean' AND NOT raw_boolean) OR (raw_kind='number' AND raw_number=-1)
    OR (raw_kind='text' AND raw_text IN ('','-1'))) THEN RETURN NULL; END IF;
  CASE raw_kind
    WHEN 'text' THEN normalized := public.masters_custom_field_trim(raw_text);
    WHEN 'boolean' THEN normalized := raw_boolean::text;
    WHEN 'number' THEN normalized := raw_number_text;
    ELSE RAISE EXCEPTION 'Unsupported raw Custom Field type' USING ERRCODE='23514';
  END CASE;
  IF normalized='' OR (is_array AND normalized='-1') THEN RETURN NULL; END IF;
  RETURN normalized;
END $$;
--> statement-breakpoint
CREATE FUNCTION masters_assert_product_custom_field_uniqueness(target_organization uuid,target_product uuid,target_revision integer) RETURNS void
LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$
BEGIN
  IF EXISTS (
...
END $$;
--> statement-breakpoint
CREATE FUNCTION masters_guard_product_custom_field_change() RETURNS trigger
...
BEGIN
  ...
  RETURN NEW;
END $$;
CREATE TRIGGER master_product_custom_field_change BEFORE INSERT OR UPDATE ON products
  FOR EACH ROW EXECUTE FUNCTION masters_guard_product_custom_field_change();
--> statement-breakpoint
CREATE FUNCTION masters_initialize_product_custom_field_metadata() RETURNS trigger
LANGUAGE plpgsql SECURITY DEFINER SET search_path=pg_catalog,public AS $$
DECLARE product public.products;
BEGIN
  SELECT * INTO product FROM public.products WHERE organization_id=NEW.organization_id AND id=NEW.product_id AND revision=NEW.revision;
  IF NOT FOUND THEN RAISE EXCEPTION 'Product field history requires its actual Product revision' USING ERRCODE='23514'; END IF;
  NEW.custom_field_count := product.custom_field_count;
  NEW.custom_fields_provided := product.custom_fields_provided;
  RETURN NEW;
END $$;
CREATE TRIGGER product_custom_field_metadata BEFORE INSERT ON product_versions
  FOR EACH ROW EXECUTE FUNCTION masters_initialize_product_custom_field_metadata();
--> statement-breakpoint
CREATE FUNCTION masters_guard_product_custom_field_history() RETURNS trigger
LANGUAGE plpgsql SECURITY DEFINER SET search_path=pg_catalog,public AS $$
  ...
  ELSE
    ...
    IF NEW.interpretation_state='valid' THEN
      CASE field.field_type
        ...
        WHEN 'lookup' THEN RAISE EXCEPTION 'This lookup has no configured source' USING ERRCODE='23514',CONSTRAINT='product_custom_value_lookup';
        ELSE
...
DO $$ DECLARE relation text; BEGIN
  FOREACH relation IN ARRAY ARRAY['product_version_custom_fields','product_version_custom_field_values'] LOOP
    EXECUTE format('ALTER TABLE %I ENABLE ROW LEVEL SECURITY',relation);
    EXECUTE format('ALTER TABLE %I FORCE ROW LEVEL SECURITY',relation);
    EXECUTE format('CREATE POLICY product_custom_field_read ON %I FOR SELECT TO sampleify_app USING
      (organization_id=nullif(current_setting(''app.organization_id'',true),'''')::uuid
        AND (SELECT app_has_permission(''masters.read'') OR app_has_permission(''masters.manage'')))',relation);
    EXECUTE format('CREATE POLICY product_custom_field_insert ON %I FOR INSERT TO sampleify_app WITH CHECK
    ...
    EXECUTE format('CREATE TRIGGER product_custom_field_history_guard BEFORE INSERT OR UPDATE OR DELETE ON %I
      FOR EACH ROW EXECUTE FUNCTION masters_guard_product_custom_field_history()',relation);
  END LOOP;
END $$;

--> statement-breakpoint
-- Only the scheme settings and counts required by Product generation are exposed.
CREATE FUNCTION masters_product_scheme_context(include_products boolean,include_samples boolean)
RETURNS TABLE("currentYearDigits" text,"nextYearDigits" text,separator text,"currentMonthFormat" text,"nonNablStartNumber" text,
  "productCount" double precision,"sampleCount" double precision)
...
BEGIN
  IF org IS NULL OR NOT public.app_has_permission('masters.manage') THEN
    RAISE EXCEPTION 'Product scheme generation requires permission' USING ERRCODE='42501';
  END IF;
  RETURN QUERY SELECT settings.scheme_current_year_digits,settings.scheme_next_year_digits,settings.scheme_separator,
    ...
    CASE WHEN include_products THEN (SELECT count(*)::double precision FROM public.products product WHERE product.organization_id=org AND product.active) ELSE 0::double precision END,
...
END $$;
REVOKE ALL ON FUNCTION masters_product_scheme_context(boolean,boolean) FROM PUBLIC,sampleify_app,sampleify_report_worker;
GRANT EXECUTE ON FUNCTION masters_product_scheme_context(boolean,boolean) TO sampleify_app;
--> statement-breakpoint
CREATE FUNCTION masters_assert_product_custom_field_preservation(target_organization uuid,target_product uuid,target_revision integer) RETURNS void
LANGUAGE plpgsql SET search_path=pg_catalog,public AS $$
...
END $$;
--> statement-breakpoint
CREATE FUNCTION masters_preserve_product_custom_fields() RETURNS trigger
LANGUAGE plpgsql SECURITY DEFINER SET search_path=pg_catalog,public AS $$
BEGIN
  ...
  INSERT INTO public.product_version_custom_field_values("organization_id","product_id","revision","field_id","position","raw_kind","raw_text","raw_number","raw_boolean","raw_number_text","interpretation_state","parsed_number","parsed_boolean","parsed_date","parsed_timestamp","option_id","option_revision","user_id","attachment_id")
    SELECT "organization_id","product_id",NEW.revision,"field_id","position","raw_kind","raw_text","raw_number","raw_boolean","raw_number_text","interpretation_state","parsed_number","parsed_boolean","parsed_date","parsed_timestamp","option_id","option_revision","user_id","attachment_id" FROM public.product_version_custom_field_values
    WHERE organization_id=NEW.organization_id AND product_id=NEW.product_id AND revision=NEW.previous_revision;
  RETURN NEW;
END $$;
CREATE TRIGGER product_custom_fields_preserve AFTER INSERT ON product_versions FOR EACH ROW EXECUTE FUNCTION masters_preserve_product_custom_fields();
--> statement-breakpoint
CREATE FUNCTION masters_check_product_custom_fields() RETURNS trigger
LANGUAGE plpgsql SECURITY DEFINER SET search_path=pg_catalog,public AS $$
BEGIN
  PERFORM public.masters_assert_product_custom_fields(NEW.organization_id,NEW.product_id,NEW.revision,true);
  PERFORM public.masters_assert_product_custom_field_preservation(NEW.organization_id,NEW.product_id,NEW.revision);
  IF NEW.custom_fields_provided THEN PERFORM public.masters_assert_product_custom_field_uniqueness(NEW.organization_id,NEW.product_id,NEW.revision); END IF;
  RETURN NULL;
END $$;
CREATE CONSTRAINT TRIGGER product_custom_fields_complete AFTER INSERT ON product_versions
  DEFERRABLE INITIALLY DEFERRED FOR EACH ROW EXECUTE FUNCTION masters_check_product_custom_fields();
--> statement-breakpoint
REVOKE ALL ON FUNCTION masters_custom_field_trim(text),masters_lock_custom_field_definition_set(),
  masters_assert_product_custom_fields(uuid,uuid,integer,boolean),masters_product_custom_field_unique_text(boolean,text,text,double precision,boolean,text),
  masters_assert_product_custom_field_uniqueness(uuid,uuid,integer),masters_guard_product_custom_field_change(),
  masters_initialize_product_custom_field_metadata(),masters_guard_product_custom_field_history(),
  masters_assert_product_custom_field_preservation(uuid,uuid,integer),masters_preserve_product_custom_fields(),masters_check_product_custom_fields()
