ALTER TABLE "workflow_transitions" ADD COLUMN "auto_move_mode" text;--> statement-breakpoint
ALTER TABLE "workflow_transitions" ADD CONSTRAINT "workflow_transition_auto_move_mode" CHECK ("workflow_transitions"."auto_move_mode" is null or "workflow_transitions"."auto_move_mode" in ('yes','no','all_trs_allocated','all_trs_approved'));--> statement-breakpoint
ALTER TABLE "workflow_transitions" ADD CONSTRAINT "workflow_transition_auto_move_pair" CHECK ("workflow_transitions"."auto_move_mode" is null or "workflow_transitions"."auto_execute"=("workflow_transitions"."auto_move_mode"='yes'));
--> statement-breakpoint
-- Preserve the recorded Auto Move choice through master cloning.
